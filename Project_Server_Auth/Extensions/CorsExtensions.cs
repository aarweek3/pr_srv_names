namespace pr_srv_names.Extensions
{
    public static class CorsExtensions
    {
            ...
            services.AddCors(options =>
            {
                options.AddPolicy("AngularPolicy", policy =>
                {
                    policy.WithOrigins(corsSettings.AllowedOrigins)
                          ...
                          .AllowAnyHeader()
                          .AllowCredentials()
                          .WithExposedHeaders("Server-Timing"); // ✅ Добавлено
                });
        ...
        {
            // Настройка CORS-политик по окружению
            if (environment.IsDevelopment())
            {
            ...
            app.Use(async (context, next) =>
            {
                ...
                if (context.Request.Method == "OPTIONS")
                {
                    ...
                    // ✅ Добавлено Server-Timing в список exposed headers
                    context.Response.Headers["Access-Control-Expose-Headers"] =
                        "Access-Control-Allow-Origin,Access-Control-Allow-Methods,Access-Control-Allow-Headers,Access-Control-Allow-Credentials,Access-Control-Max-Age,Server-Timing";
                ...
                // Добавление CORS-заголовков для всех ответов
                context.Response.OnStarting(() =>
                {
                    if (context.Request.Headers.ContainsKey("Origin"))
                    {
                        ...
                        context.Response.Headers["Access-Control-Expose-Headers"] =
                            ...
                            "X-Content-Type-Options,X-Frame-Options,X-XSS-Protection,Strict-Transport-Security,Content-Security-Policy,Referrer-Policy,Server-Timing";
                    }
