...
namespace pr_srv_names.Pages.Language.Services
{
    public class LanguageProfile : Profile
    {
        public LanguageProfile()
        {
            ...
            CreateMap<DAL.Models.Language, LanguageDetailDto>()
            ...
            CreateMap<LanguageCreateRequestDto, DAL.Models.Language>()
                .ForMember(dest => dest.Code, opt => opt.MapFrom(src => src.Code))
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(dest => dest.FlagCode, opt => opt.MapFrom(src => src.FlagCode))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description))
            ...
            CreateMap<LanguageUpdateRequestDto, DAL.Models.Language>()
                .ForMember(dest => dest.Code, opt => opt.MapFrom(src => src.Code))
                .ForMember(dest => dest.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(dest => dest.FlagCode, opt => opt.MapFrom(src => src.FlagCode))
                .ForMember(dest => dest.Description, opt => opt.MapFrom(src => src.Description))
