...
/// Используется для валидации и приёма данных с фронтенда.
/// </summary>
public class UserSettingsUpdateDto
{
    ...
    /// </summary>
    [MaxLength(10)]
    [RegularExpression(@"^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$", ErrorMessage = "Цвет должен быть в формате HEX (#RRGGBB или #RGB)")]
    ...
    /// </summary>
    [Required(ErrorMessage = "Часовой пояс обязателен")]
    [MaxLength(50)]
